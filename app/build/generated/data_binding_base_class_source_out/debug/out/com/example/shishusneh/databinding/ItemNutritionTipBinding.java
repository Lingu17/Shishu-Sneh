...
public final class ItemNutritionTipBinding implements ViewBinding {
  ...
  private ItemNutritionTipBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivTipIcon,
      @NonNull TextView tvTipDescription, @NonNull TextView tvTipTitle) {
  ...
  public static ItemNutritionTipBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNutritionTipBinding((MaterialCardView) rootView, ivTipIcon, tvTipDescription,
          tvTipTitle);
    }
